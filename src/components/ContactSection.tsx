        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-muted mb-8 leading-relaxed">
              Have a project in mind? Leave your details and we&apos;ll contact you within 1-2 hours to discuss your requirements.
            </p>

            {/* Contact Options */}
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 rounded-xl border border-foreground/10">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted">Fastest response</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl border border-foreground/10">
                ...
                <div>
                  <p className="font-medium">ai@n01.app</p>
